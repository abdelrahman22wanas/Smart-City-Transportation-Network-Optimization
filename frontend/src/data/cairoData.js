...
export const facilities = [
  { id: 'F1', name: 'Cairo International Airport', type: 'Airport', x: 31.41, y: 30.11, location: 'East Cairo', capacity: 75000 },
  { id: 'F2', name: 'Ramses Railway Station', type: 'Transit Hub', x: 31.25, y: 30.06, location: 'Downtown Cairo', capacity: 150000 },
  { id: 'F3', name: 'Cairo University', type: 'Education', x: 31.21, y: 30.03, location: 'Giza', capacity: 80000 },
  { id: 'F4', name: 'Al-Azhar University', type: 'Education', x: 31.26, y: 30.05, location: 'Islamic Cairo', capacity: 100000 },
  { id: 'F5', name: 'Egyptian Museum', type: 'Tourism', x: 31.23, y: 30.05, location: 'Tahrir Square', capacity: 50000 },
  { id: 'F6', name: 'Cairo International Stadium', type: 'Sports', x: 31.3, y: 30.07, location: 'New Cairo', capacity: 75000 },
  { id: 'F7', name: 'Smart Village', type: 'Business', x: 30.97, y: 30.07, location: 'Sheikh Zayed', capacity: 120000 },
  { id: 'F8', name: 'Cairo Festival City', type: 'Commercial', x: 31.4, y: 30.03, location: 'New Cairo', capacity: 100000 },
  { id: 'F9', name: 'Qasr El Aini Hospital', type: 'Medical', x: 31.23, y: 30.03, location: 'Abdeen', capacity: 1000 },
  { id: 'F10', name: 'Maadi Military Hospital', type: 'Medical', x: 31.25, y: 29.95, location: 'Maadi', capacity: 800 },
];

export const existingRoads = [
  { from: 1, to: 3, distance_km: 8.5, capacity_veh_h: 3000, condition: 7, travel_time_min: 12, cost: 2500 },
  { from: 1, to: 8, distance_km: 6.2, capacity_veh_h: 2500, condition: 6, travel_time_min: 10, cost: 1800 },
  { from: 2, to: 3, distance_km: 5.9, capacity_veh_h: 2800, condition: 8, travel_time_min: 9, cost: 1700 },
  { from: 2, to: 5, distance_km: 4.0, capacity_veh_h: 3200, condition: 9, travel_time_min: 7, cost: 1200 },
  { from: 3, to: 5, distance_km: 6.1, capacity_veh_h: 3500, condition: 7, travel_time_min: 10, cost: 1800 },
  { from: 3, to: 6, distance_km: 3.2, capacity_veh_h: 2000, condition: 8, travel_time_min: 6, cost: 950 },
  { from: 3, to: 9, distance_km: 4.5, capacity_veh_h: 2600, condition: 6, travel_time_min: 8, cost: 1300 },
  { from: 3, to: 10, distance_km: 3.8, capacity_veh_h: 2400, condition: 7, travel_time_min: 7, cost: 1100 },
  { from: 4, to: 2, distance_km: 15.2, capacity_veh_h: 3800, condition: 9, travel_time_min: 22, cost: 4500 },
  { from: 4, to: 14, distance_km: 5.3, capacity_veh_h: 3000, condition: 10, travel_time_min: 8, cost: 1550 },
  { from: 5, to: 11, distance_km: 7.9, capacity_veh_h: 3100, condition: 7, travel_time_min: 12, cost: 2300 },
  { from: 6, to: 9, distance_km: 2.2, capacity_veh_h: 1800, condition: 8, travel_time_min: 4, cost: 650 },
  { from: 7, to: 8, distance_km: 24.5, capacity_veh_h: 3500, condition: 8, travel_time_min: 35, cost: 7200 },
  { from: 7, to: 15, distance_km: 9.8, capacity_veh_h: 3000, condition: 9, travel_time_min: 14, cost: 2900 },
  { from: 8, to: 10, distance_km: 3.3, capacity_veh_h: 2200, condition: 7, travel_time_min: 6, cost: 1000 },
  { from: 8, to: 12, distance_km: 14.8, capacity_veh_h: 2600, condition: 5, travel_time_min: 22, cost: 4400 },
  { from: 9, to: 10, distance_km: 2.1, capacity_veh_h: 1900, condition: 7, travel_time_min: 4, cost: 620 },
  { from: 10, to: 11, distance_km: 8.7, capacity_veh_h: 2400, condition: 6, travel_time_min: 13, cost: 2550 },
  { from: 11, to: 'F2', distance_km: 3.6, capacity_veh_h: 2200, condition: 7, travel_time_min: 6, cost: 1050 },
  { from: 12, to: 1, distance_km: 12.7, capacity_veh_h: 2800, condition: 6, travel_time_min: 19, cost: 3750 },
  { from: 13, to: 4, distance_km: 45, capacity_veh_h: 4000, condition: 10, travel_time_min: 65, cost: 13200 },
  { from: 14, to: 13, distance_km: 35.5, capacity_veh_h: 3800, condition: 9, travel_time_min: 51, cost: 10400 },
  { from: 15, to: 7, distance_km: 9.8, capacity_veh_h: 3000, condition: 9, travel_time_min: 14, cost: 2900 },
  { from: 'F1', to: 5, distance_km: 7.5, capacity_veh_h: 3500, condition: 9, travel_time_min: 11, cost: 2200 },
  { from: 'F1', to: 2, distance_km: 9.2, capacity_veh_h: 3200, condition: 8, travel_time_min: 13, cost: 2700 },
  { from: 'F2', to: 3, distance_km: 2.5, capacity_veh_h: 2000, condition: 7, travel_time_min: 5, cost: 750 },
  { from: 'F7', to: 15, distance_km: 8.3, capacity_veh_h: 2800, condition: 8, travel_time_min: 12, cost: 2450 },
  { from: 'F8', to: 4, distance_km: 6.1, capacity_veh_h: 3000, condition: 9, travel_time_min: 9, cost: 1800 },
  { from: 'F9', to: 3, distance_km: 1.2, capacity_veh_h: 2000, condition: 10, travel_time_min: 2, cost: 350 },
  { from: 'F9', to: 10, distance_km: 0.9, capacity_veh_h: 2000, condition: 10, travel_time_min: 2, cost: 270 },
  { from: 'F10', to: 1, distance_km: 1.1, capacity_veh_h: 2000, condition: 10, travel_time_min: 2, cost: 320 },
];
